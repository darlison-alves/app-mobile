...
import cache, { cacheClean, ICacheResult } from '~/helpers/rxjs-operators/cache';
import { IOrder, IUser } from '~/interfaces/models/user';
...
export class UserService {
  ...
  public requestOrder(data: IOrder): Observable<void> {
    return this.getDeviceInformation().pipe(
      switchMap(() => {
